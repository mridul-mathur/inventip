...
const Footer: React.FC = () => {
  ...
  return (
    <main className='z-[2] border min-h-[40vh] bg-primary text-black rounded-t-[3rem] border-black flex w-full absolute flex-col sm:flex-row pb-5 sm:pb-0'>
      <div className='logo-div w-[80%] p-12 flex flex-col gap-6'>
        <Link href={'/'}>
          <img
      ...
      <div className='w-[100%] p-0 m-0 flex justify-start items-center'>
        <div className='flex items-start justify-start gap-4 sm:gap-16'>

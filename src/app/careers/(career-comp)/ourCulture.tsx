...
const OurCluture = () => {
  ...
  return (
    <main className='z-[2] bg-primary text-secondary w-screen h-fit flex flex-col justify-between items-center gap-12 p-4 sm:py-[4rem] sm:p-[8rem]'>
      <div className='flex gap-6 h-fit '>
        <div className='relative items-start justify-start w-2/3 flex flex-col text-left gap-4'>
          ...
          <h1 className='text-para text-justify'>
      ...
      <div className='flex min-h-auto w-full flex-col p-2 gap-12 sm:flex-row'>
        <div className='relative min-h-auto flex w-1/2 flex-col gap-4'>

...
//             para: "there comes some lines about the current certificate which is showing at the rights most part and some more lines will come here regarding it.",
...
//     return (
//         <main   
//             className="h-[90vh] w-screen bg-white flex p-16 overflow-x-hidden"
...
//             </div>
//             <div
//                 className="right-image h-full w-[100%] flex items-center p-12 gap-x-4 overflow-x-scroll scrollbar-none mx-5"
//                 ref={rightImageRef}
//             >
//                 {slides.map((slide, index) => (
//                     <motion.div
//                         key={`image-${index}`}
//                         className={`h-[80%] min-w-[280px] border  rounded-[2rem] flex-shrink-0 m-5 overflow-hidden ${
//                             currentIndex === index ? "scale-110 bg-gray-300" : "bg-white"
//                         }`}
//                         initial={{
...
const Certified: React.FC = () => {
    ...
    return (
        <main
            className="h-[90vh] w-screen bg-white flex p-16 overflow-hidden"
            onClick={handleNextSlide}
        >
            <div className="left-detail h-full w-[50%] flex flex-col justify-evenly pl-2">
                <h1 className="text-head capitalize">
